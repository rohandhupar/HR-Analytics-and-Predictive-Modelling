# -*- coding: utf-8 -*-
"""
Created on Sat Nov 11 23:39:29 2017

@author: rohan
"""

# major certifiaction project , Human resource analytics 
#importing data 
import pandas as pd 
...
# oue report says that employess who left were actually having samne number of yr 
...
sns.countplot(x="workAccident",data=df,palette=['pink','lightgreen'],hue="turnover")
